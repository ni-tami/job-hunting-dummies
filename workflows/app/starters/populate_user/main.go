...
import (
	...
	uWorkflow "github.com/ni-tami/job-hunting-dummies-workflows/app/populate_user/workflows"
...
func RunPopulateUser(ctx context.Context, c client.Client) {
	...
	scheduleHandle, err := c.ScheduleClient().Create(ctx, client.ScheduleOptions{
		...
		Action: &client.ScheduleWorkflowAction{
			ID:        workflowID,
			Workflow:  uWorkflow.PopulateUserWorkflow,
